...
function update(){
  if(!hasData()){
    document.getElementById('preview').innerHTML=
      '<div class="empty-state">'+
        '<svg width="48" height="48" fill="none" viewBox="0 0 24 24" stroke="#9ca3af" stroke-width="1.2">'+
          '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>'+
        '</svg>'+
        '<p>Form bharein — receipt yahan dikhegi</p>'+
      '</div>';
    return;
  }
  ...
  document.getElementById('preview').innerHTML=
    '<div class="receipt">'+
    '<div class="r-header">'+
      '<div class="r-head-inner">'+
        '<div class="r-logo"><img src="1.jpg" alt="GUV" onerror="this.parentElement.innerHTML=\'GUV\'"></div>'+
        '<div>'+
          '<p class="r-school-name">Gyanodaya Uchch Vidyalaya</p>'+
          '<p class="r-school-addr">Lakshmeswar Nagar, Hajipur (Vaishali)</p>'+
          '<p class="r-school-contact">guv.hajipur@gmail.com &nbsp;|&nbsp; 9199977736, 9931102464</p>'+
        '</div>'+
      '</div>'+
    '</div>'+
    ...
    '<div class="r-info-grid">'+
      ...
      '<div class="r-ic"><div class="r-il">Class &amp; Section &amp; Roll No. </div><div class="r-iv">'+cls+'-'+sec+' /'+roll+'</div></div>'+
      '<div class="r-ic"><div class="r-il"> Month</div><div class="r-iv"> '+month+'</div></div>'+
    '</div>'+
    '<table class="r-table">'+
